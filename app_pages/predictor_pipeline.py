...
def page_pipeline_overview():
    ...
    st.info(
        ...
        f"* The training performance, with a **Mean Absolute Error (MAE) of 16 million**, "
        f"demonstrates that the model performs exceptionally well on known data. However, the significantly higher **test error (MAE: 43 million)** highlights the challenges in predicting revenue accurately for new films, "
